...
<body>
    ...
    %>
		<form class="sectionForm" action="AddVehicleServlet" method="post">
...
two_wheeler
	...
	<script src="../../assets/javascript/customerBuildInFunction.js"></script>
	<script src="../../assets/javascript/customer_function.js"></script>
	<script src="../../assets/javascript/buildedfunction.js"></script>
	<script type="module" src="../../assets/javascript/livebooking.js"></script>
