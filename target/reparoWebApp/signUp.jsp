  ...
  <div class="login">
    ...
    %>
      ...
      <div class="inputContainer">
        ...
        <div class="cont">
          <span class="material-symbols-outlined" style="color: white;">dialpad</span>
          <input pattern="[A-Za-z0-9]{6,10}" title="Password Should be in 6 to 10 digits mixed up of alphabets and numbers" required name="Cpassword" type="password" style="border-bottom: 2px solid white;">
        </div>
      </div>
